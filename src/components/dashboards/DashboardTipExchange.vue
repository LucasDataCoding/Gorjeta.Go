<template>
  <Tabs default-value="individual">
    <TabsList>
      <TabsTrigger value="individual"> conta individual </TabsTrigger>
      <TabsTrigger value="group"> conta do grupo </TabsTrigger>
    </TabsList>
    ...
    -->
    <TabsContent value="individual" class="space-y-8">
      ...
      <MainSection>
        ...
        <template #content>
          <div class="lg:grid lg:grid-cols-12 lg:gap-5 space-y-10 lg:space-y-0 items-center">
            <ol
              class="col-span-7 list-decimal list-outside mt-5 lg:mt-0 ml-4 space-y-3 lg:space-y-2 font-semibold text-base lg:py-5"
            >
              <li>
                Conta do grupo
    ...
    <TabsContent value="group"> Dashboard de conta do grupo aqui </TabsContent>
  </Tabs>
</template>
